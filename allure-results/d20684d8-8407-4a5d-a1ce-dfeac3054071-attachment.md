  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e196]:
          ...
          - list [ref=e281]:
            ...
            - listitem [ref=e285]:
              ...
              - link "Account" [ref=e286] [cursor=pointer]:
                - /url: https://ecommerce-playground.lambdatest.io/index.php?route=account/account
            - listitem [ref=e287]: / Logout
        - generic [ref=e288]:
          - generic [ref=e289]:
            - heading " Account Logout" [level=1] [ref=e290]:
              - generic [ref=e291]: 
              - text: Account Logout
            - paragraph
            - paragraph [ref=e292]: You have been logged off your account. It is now safe to leave the computer.
            - paragraph [ref=e293]: Your shopping cart has been saved, the items inside it will be restored whenever you log back into your account.
            - paragraph
            - link "Continue" [ref=e295] [cursor=pointer]:
              - /url: https://ecommerce-playground.lambdatest.io/index.php?route=common/home
          - complementary [ref=e296]:
            - generic [ref=e297]:
              - link " Login" [ref=e298] [cursor=pointer]:
              ...
              - link " Register" [ref=e300] [cursor=pointer]:
                ...
                - generic [ref=e301]: 
                - text: Register
              - link " Forgotten Password" [ref=e302] [cursor=pointer]:
      ...
      - contentinfo [ref=e324]:
        - paragraph [ref=e330]: © LambdaTest - Powered by OpenCart
  - text:  
```